...
-- ----------------------------
-- Procedure structure for insert_AutoConectPort
-- ----------------------------
DROP PROCEDURE IF EXISTS `insert_AutoConectPort`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `insert_AutoConectPort`(IN portname varchar (100),IN description varchar (8000))
BEGIN
	INSERT INTO ca_autoconnectports (portname,description) VALUES (portname,description);
END
;;
DELIMITER ;
